package com.example.myapp.RecyclerView.Rcv_PhieuMuon.RecyclerView_DaTra;
...
public class DaTra_Adapter extends RecyclerView.Adapter<DaTra_Adapter.viewHodler>{
    ...
    public DaTra_Adapter(Context mContext) {
    ...
    public viewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DaTra_Adapter.viewHodler(view);
    }
